...
internal extension NavLibInstance {
    static var properties: [navlib.property_t] {
        [
            ...
            navlib.focus_k,
            navlib.motion_k,
            navlib.coordinate_system_k,
            navlib.transaction_k,
            navlib.frame_time_k,
            navlib.frame_timing_source_k,
            navlib.device_present_k,
            navlib.commands_tree_k,
            navlib.commands_activeCommand_k,
            navlib.commands_activeSet_k,
            navlib.images_k,
            navlib.view_affine_k,
            navlib.view_constructionPlane_k,
            navlib.view_extents_k,
            navlib.view_fov_k,
            navlib.view_frustum_k,
            navlib.view_perspective_k,
            navlib.view_target_k,
            navlib.view_rotatable_k,
            navlib.view_focusDistance_k,
            navlib.views_front_k,
            navlib.pivot_position_k,
            navlib.pivot_user_k,
            navlib.pivot_visible_k,
            navlib.hit_lookfrom_k,
            navlib.hit_direction_k,
            navlib.hit_aperture_k,
            navlib.hit_lookat_k,
            navlib.hit_selectionOnly_k,
            navlib.selection_affine_k,
            navlib.selection_empty_k,
            navlib.selection_extents_k,
            navlib.model_extents_k,
            navlib.model_floorPlane_k,
            navlib.model_unitsToMeters_k,
            navlib.pointer_position_k,
            navlib.events_keyPress_k,
            navlib.events_keyRelease_k,
            navlib.settings_changed_k
        ]
    }
}

extension NavLibInstance {
...
extension NavLibInstance.Property where T == Int {
...
extension NavLibInstance.Property where T == Bool {
    ...
    static let hasPivotOverride = Self(navlib.pivot_user_k)
    static let hasEmptySelection = Self(navlib.selection_empty_k)
}

extension NavLibInstance.Property where T == navlib.matrix_t {
    ...
    static let selectionTransform = Self(navlib.selection_affine_k)
}

extension NavLibInstance.Property where T == navlib.box_t {
    static let modelExtents = Self(navlib.model_extents_k)
    static let orthographicViewExtents = Self(navlib.view_extents_k)
    static let selectionExtents = Self(navlib.selection_extents_k)
}

extension NavLibInstance.Property where T == navlib.point_t {
...
extension NavLibInstance.Property where T == navlib.vector_t {
