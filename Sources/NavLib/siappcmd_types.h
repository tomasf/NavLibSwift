...
// File History
//
// $Id: siappcmd_types.h 19994 2023-02-21 14:02:24Z mbonk $
//
...
extern "C" {
  ...
  /*------------------------------------+---------------------------------------
      ...
      id
          The id field specifies a string identifier for the action set, category, or action
          represented by the node. The field is always non-NULL and constructed from a basic
          set of printable ASCII characters: "A" to "Z" (27 uppercase letters), "a" to "z"
          (27 lowercase letters), "0" to "9" (digits), "_" (underscore character), "-"
          (dash character) and "." (dot or period character).
          This string needs to remain constant across application sessions and across
          application releases. The string must not change with the application language or
          other UI localization. The id is used by the application to identify an action.
